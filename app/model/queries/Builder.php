...
class Builder
{
	 ...
	 * @param string 	$table
	 * @param PDO 		$connexion 		default = PDO in app/model/Connect.php
	 */
	public function __construct($table, $connexion = false)
	{
		$this->table = $table;
		if (!$connexion) {
			$connexion = Setup::getConnexion();
		}
	...
	private function setSql()
	{
		if ($this->req_type === "UPDATE") {
			...
			$tags = $this->setInsertTags($this->tags);
	...
	/**
	 * Set list of tags in the sql request for insert
